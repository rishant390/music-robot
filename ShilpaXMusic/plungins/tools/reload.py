...
from ShilpaXMusic.utils.database import get_assistant, get_authuser_names, get_cmode
from ShilpaXMusic.utils.decorators import ActualAdminCB, AdminActual, language
from ShilpaXMusic.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Shilpa.stop_stream_force(chat_id)
        except:
            pass
